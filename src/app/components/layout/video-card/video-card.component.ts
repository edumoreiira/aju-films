  ...
  videoCards: VideoCard[] = [
    {
      ...
      videoUrl: './videos/residencial2.mp4',
    ...
    },
    {
      ...
      description: 'Instalação rápida e sem sujeira, películas de controle solar aplicadas com corte computadorizado avançado, sem o uso do estilete, para um acabamento impecável e profissional em qualquer superfície.',
      videoUrl: './videos/corte-computadorizado.mp4',
      footer1: 'Modelo de película',
      footer2: 'Espelhado',
